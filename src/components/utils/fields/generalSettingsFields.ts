...
export const generalSettingsFields: FieldConfig[] = [
  ...
  { name: 'siteLogo', label: 'Site Logo', type: 'file', required: false },
  { name: 'favicon', label: 'Favicon', type: 'file', required: false },
  { name: 'defaultCurrency', label: 'Default Currency', type: 'text', required: true },
  { name: 'currencyIcon', label: 'Currency Icon', type: 'text', required: false },
